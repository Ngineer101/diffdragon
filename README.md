...
Single-command install/setup/update for LM Studio service:
...
Before starting, create your LM Studio config file at `~/.config/diffdragon/lmstudio.env`:
...
Run again any time to update/reinstall:
